...
/***/ (function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", getOntologyContent, false);

	function getOntologyContent() {

		if(typeof ontologyMenu != 'undefined') {
		console.log("Loading");
		ontologyMenu.setConversionID(-10000);
			ontologyContent = document.getElementById("ontology-code").textContent;
		ontologyIdentifierFromURL = "";
		parseOntologyContent(ontologyContent);
		}
		else {
			setTimeout(getOntologyContent, 250);
		}
